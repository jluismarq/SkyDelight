...
class LoginFragment : Fragment() {
    ...
    private fun login(email: String, password: String) {
        ...
        ValidationsDialogsRequests().httpPetition(request, findNavController().context, requireActivity(),
            binding.btnLogin, binding.btnReturn, null, null, getString(R.string.loadingDialog_login), 401,
            "¡Error! ¡Acceso Prohibido!","¡No Existe la Cuenta o el Correo y Contraseña son Erróneos!",
            null)
